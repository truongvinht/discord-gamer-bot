...
class YuanShenService extends ApiAccessService {
    ...
    mapFigureNickname (name) {
        const nickNameMap = { childe: 'tartaglia', sucrose: 'saccharose', hutao: 'hu tao', kazuha: 'kaedehara kazuha', ayaka: 'kamisato ayaka', baal: 'raiden shogun', sara: 'kujou sara', kokomi: 'sangonomiya kokomi', yunjin: 'yun jin', ayato: 'kamisato ayato', itto: 'arataki itto', miko: 'yae miko', kuki: 'kuki shinobu', heizou: 'shikanoin heizou' };
    ...
    validateLongFigureName (name) {
        const playerNames = ['hu tao', 'kaedehara kazuha', 'kamisato ayaka', 'raiden shogun', 'kujou sara', 'sangonomiya kokomi', 'kamisato ayato', 'yun jin', 'arataki itto', 'yae miko', 'kuki shinobu', 'shikanoin heizou'];
